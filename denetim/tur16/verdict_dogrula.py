#!/usr/bin/env python3
"""Tur-16 denetim: verdict-tur16.json şema + CRITICAL/HIGH↔fail tutarlılığı + artefakt sha256'larını diskten yeniden hesaplar.
Kullanım: python3 denetim/tur16/verdict_dogrula.py  (repo kökünden)
"""
import hashlib, json, os, sys

v = json.load(open("denetim/verdict-tur16.json", encoding="utf-8"))
