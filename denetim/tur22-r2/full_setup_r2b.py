#!/usr/bin/env python3
# r2 denetçi kurulum v2: Sohbet->Sunucular->Düzenle->adres 10.0.2.2:9171->Kaydet->sohbet
import sys, time
...
P.tap('Sohbet', 2)
if not any((n['t'] or n['cd']) == 'Sunucular' for n in P.nodes()):
    # Ayarlar listesinde kaldıysak yukarı kaydır (adb swipe)
    P.sh(P.ADB + ['shell', 'input', 'swipe', '540', '1600', '540', '700', '300'])
    time.sleep(1)
    P.sh(P.ADB + ['shell', 'input', 'swipe', '540', '1600', '540', '700', '300'])
P.tap('Sunucular', 2.5)
dump('sunucular')
